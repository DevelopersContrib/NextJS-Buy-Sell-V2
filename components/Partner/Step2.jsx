    ...
    <>
      ...
      <div className="row">
        <div className="col-xl-12 tw-text-center mb-3">
          ...
          <p>
            Please complete your profile in order to present your partnership to
            the domain owner.
          </p>
        </div>
        <div className="col-xl-12">
          ...
          <div className="d-grid tw-grid-cols-2 tw-gap-4">
            <a href="" className="btn btn-light border py-3" onClick={prevStep}>
              BACK
            </a>
